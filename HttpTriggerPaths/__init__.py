...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    KVUri = "https://kv-dtlkrenewables-dev.vault.azure.net/"
    ...
    print(client.get_secret("storageAccountKey").value)
    ...
    directory_client_sink = file_system_client.get_directory_client("smp/json")    
    ...
    for path in path_list:
        if path.name.startswith("smp/raw_data/") & path.name.endswith(".MED"):
